...
if (!class_exists('devvn_reviews_auto_update')) {
    class devvn_reviews_auto_update
    {
        ...
        public $download_link = 'https://github.com/itvn9online/devvn-woocommerce-reviews/archive/refs/heads/main.zip';
    ...
    function devvn_devvn_reviews_auto_update()
    {
        ...
        $devvn_plugin_remote_path = 'https://raw.echbay.com/itvn9online/devvn-woocommerce-reviews/main/VERSION';
